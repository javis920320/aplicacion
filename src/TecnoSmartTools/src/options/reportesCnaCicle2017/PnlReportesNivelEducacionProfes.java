...
public class PnlReportesNivelEducacionProfes extends javax.swing.JPanel {

    SwingWorker sw;

    public PnlReportesNivelEducacionProfes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtPath.setText("C:\\\\Users\\\\umariana\\\\Desktop\\\\Reportes Cna Diciembre 2017\\\\Docentes Nivel Educacion\\\\");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            if (txtCodProgs.getText().trim().isEmpty()) {
                throw new Exception("Ingrese codigos de programa separados por coma , ");
            }
            pgBar.setIndeterminate(true);
            final String pathReoprte = "./src/jasper/";
            //final String reporte = "NivelDeFormacionDedicacion.jasper";
            final String reporte = "rp_cna_profes_nivel_edu.jasper";
                ...
                protected Boolean doInBackground() {
                    try {
                        ...
                        for (int i = 0; i < codsProgs.length; i++) {
                            ...
                            String codigoSnies = codsProgs[i].trim();
                            Object[][] data = ExecuteSql.executeQuery("SELECT "
                                    + "RP.NOM_PROG||' '||Z.NOMBRE, "
                                    + "F.NOM_FACUL "
                                    + "FROM RE_ZON_PRO ZP "
                                    ...
                                    + "WHERE ZP.COD_SNIES =" + codigoSnies);
                            String nomPro = data[0][0].toString();
                            String facultad = data[0][1].toString();
                            String nomArchivo = codigoSnies + " " + nomPro ;

                            File dir = new File(txtPath.getText() + "\\" + " " + codigoSnies);
                            dir.mkdir();
                            ...
                            parameters.put("PROGRAMA", codigoSnies);
                            ...
                            try {
                                JasperPrintExport.export(pathReoprte, reporte, nomArchivo, nDirPat, null, parameters, RptProfesNivelEdu.class);
                            } catch (Exception e) {
                                infoText += "Error en " + nomArchivo + "   " + e.getMessage();
                            }
                        ...
                        Dialogs.infoDialog(PnlReportesNivelEducacionProfes.this, "Generacion de archivos Terminada....");
                        pgBar.setIndeterminate(false);
                    } catch (Exception e) {
                        Dialogs.errorDialog(PnlReportesNivelEducacionProfes.this, e);
                    }
                    return true;
                }
            };
