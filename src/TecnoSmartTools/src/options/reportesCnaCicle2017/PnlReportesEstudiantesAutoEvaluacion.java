...
public class PnlReportesEstudiantesAutoEvaluacion extends javax.swing.JPanel {

    SwingWorker sw;

    public PnlReportesEstudiantesAutoEvaluacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtPath.setText("C:\\\\Users\\\\umariana\\\\Desktop\\\\Reportes Cna Diciembre 2017\\\\Estudiantes\\\\");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            final String reporte = "ReportAutoEvaluacion2.jasper";
            sw = new SwingWorker<Boolean, Boolean>() {
                ...
                protected Boolean doInBackground() throws Exception {
                    ...
                    for (int i = 0; i < codsProgs.length; i++) {
                        ...
                        parameters.put("p_anio_ini", yearBegP);
                        parameters.put("p_anio_fin", yearEndP);
                        parameters.put("p_pro_consecutivo", codigoSnies);
                        try {
                            JasperPrintExport.export(pathReoprte, reporte, nomArchivo, nDirPat, null, parameters);
                        } catch (Exception e) {
                            e.printStackTrace();
                    ...
                    Dialogs.infoDialog(PnlReportesEstudiantesAutoEvaluacion.this, "Generacion de archivos Terminada....");
